...
tot_iters = 10
refine_type = 'bc'
unormL2_bc,unormH1_bc,pnorm_bc,inf_sup_bc,iterhold_bc= stokes_IPM(h, tot_iters, tol, numRefines, refine_type)
refine_type = 'ic'
unormL2_ic,unormH1_ic,pnorm_ic,inf_sup_ic,iterhold_ic = stokes_IPM(h, tot_iters, tol, numRefines, refine_type)
